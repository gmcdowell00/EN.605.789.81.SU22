...
@Controller
public class CreateTaskApiController implements CreateTaskApi {

    private static final Logger log = LoggerFactory.getLogger(CreateTaskApiController.class);
    ...
    public CreateTaskApiController(ObjectMapper objectMapper, HttpServletRequest request) {
